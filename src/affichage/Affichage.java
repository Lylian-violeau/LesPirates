...
public interface Affichage {
	...
	public default void initJoueurs() {
		System.out.println("Joueur 1, donnez votre nom.");
	...
	public default void initContexte() {
	...
	public default void initRegles() {
